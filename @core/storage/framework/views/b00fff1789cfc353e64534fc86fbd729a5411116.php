...
<form method="POST" action="<?php echo e($paystack_data['route']); ?>" accept-charset="UTF-8" class="form-horizontal" role="form">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            ...
            <p>
                <button id="submit_btn" type="submit" ><?php echo e(__('Processing..')); ?></button>
            </p>
        </div>
    </div>
</form>
...
<script>
    ...
    "use strict";
        ...
        $(document).ready(function (){
            ...
            submitBtn.text("<?php echo e(__('Please stay on the page')); ?>");
            submitBtn.css({
...
<?php /**PATH /home/bhpegejb/altdream.app/@core/resources/views/payment/paystack.blade.php ENDPATH**/ ?>