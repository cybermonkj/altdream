...
<?php endif; ?>
                            ...
                            <?php if($donation->emmergency === 'on'): ?>
                                <!-- <div class="alert alert-danger">
                                    <div class="contribute-alert">
                                        <span> <i class="lab la-android"></i> This fundrraiser is urgent </span>
                                    </div>  
                                </div> -->
                            <?php endif; ?>
                        ...
                        <?php else: ?>
                            ...
                            <?php if($donation->emmergency === 'on'): ?>
                                <div class="alert alert-danger">
                                    <div class="contribute-alert">
                                        <span> <i class="lab la-android"></i> Urgent Fundraiser</span>
                                    </div>
                                </div>
                            <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bhpegejb/altdream.app/@core/resources/views/frontend/donations/donation-single.blade.php ENDPATH**/ ?>