...
<?php endif; ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="col-lg-12">
                        <div class="alert alert-warning d-block"><?php echo e(__('No Fundraiser's Associated with this Category')); ?></div>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> ?><?php /**PATH /home/bhpegejb/altdream.app/@core/resources/views/frontend/donations/donation-category.blade.php ENDPATH**/ ?>