...
class NewsletterController extends Controller
{
    ...
    public function verify_mail_send(Request $request){
        ...
        $message = __('Verify your email to get all updates from '). get_static_option('site_'.get_default_language().'_title') . '<div class="btn-wrap"> <a class="anchor-btn" href="' . route('subscriber.verify', ['token' => $token]) . '">' . __('verify email') . '</a></div>';
        $data = [
            'message' => $message,
