...
<form method="POST" action="{{$flutterwave_data['form_action']}}" id="paymentForm">
    ...
    {{--                <input type="hidden" name="lastname" value="Joshua" /> <!-- Replace the value with your customer lastname -->--}}
    ...
    {{--                <input type="hidden" name="phonenumber" value="08102414599" /> <!-- Replace the value with your customer phonenumber -->--}}
...
<script>
    document.addEventListener('DOMContentLoaded',function (){
        ...
        document.getElementById('submit_btn').value = "{{__('Processing..')}}";
    });
</script>
</body>
</html>
