...
<head>
    ...
    <title>{{__('A New Donation has been recieved')}} {{get_static_option('site_title')}}</title>
    <style>
        *{
...
<div class="mail-container">
    ...
    <div class="main-content-wrap">
        ...
        @else
            <p>{{__('You got a new payment from')}} {{$data->name}} {{__('For donation log ID') .'#'}} {{$data->id}}, {{__('donated cause')}} {{'"'.$data->cause->title.'"'}} {{__('processed via')}} {{ucfirst(str_replace('_',' ',$data->payment_gateway))}}</p>
        @endif
