...
<head>
    ...
    <title>Altdream Re-Initializer</title>
...
$extensions = [
    'BCMath', 'Ctype', 'JSON', 'Mbstring', 'OpenSSL', 'PDO', 'pdo_mysql', 'Tokenizer', 'XML', 'cURL', 'fileinfo','Intl'
];
    ...
    <div class="get-support">
        <div class="icon-wrap">
            <ul class="support-list">
                ...
                <li><a href="mailto:admin@altdream.app">Tell Super Admin</a></li>
            </ul>
            ...
            <div class="col-lg-10">
                <div class="form-outer-wrapper">
                    <div class="brand-logo">
                        <h2 class="title">Aldream</h2>
                        <p>Initialization Wizard</p>
                    </div>
                    <form id="msform" action="index.php" method="post">
                        <!-- progressbar -->
                        <ul id="progressbar">
                            <li class="active">Warnig</li>
                        ...
                        <div class="content-wrap with-step">
                            <h4>Fix</h4>
                            <p>This wizard would re-attempt re-installation of Altdream on the server, please do not proceed if this is a production server and instead contact your super admin</p>

                            <p><i class=""></i> If this error occured after you edited some code/database, it is recommended you first Undo your changes.</p>

                            <button type="button" class="next action-button">I Understand, Next Step</button>
                        </div>
                        <div class="content-wrap with-step">
                            <h4>Altdream Requirements</h4>
                        ...
                        <div class="content-wrap with-step">
                            ...
                            <table class="requirement-check">
                                ...
                                <tr>
                                    ...
                                    <td>Required <strong>database.sql</strong> available (Warning this would reset database)</td>
                                    <td>
                                        <?php
                                        $database_errors = 0;
                            ...
                            <?php if ($database_errors > 0):?>
                                <div class="alert alert-danger mt-2" style="text-transform: capitalize;">your installation <strong>database.sql</strong> file is missing, contact technical admin immediatly</div>
                            <?php endif;?>
                            <button type="button" class="previous action-button">Previous</button>
                        ...
                        <div class="content-wrap with-step">
                            ...
                            <button type="submit" class="action-button hide" id="install_now"> Reset Now</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="copyright-inner">
                    &copy; 2022 All Right Reserved By <a href="https://altdream.app">Altdream</a>
                </div>
            </div>
        </div>
    </div>
